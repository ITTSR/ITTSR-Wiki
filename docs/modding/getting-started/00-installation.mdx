...
:::caution
One day I'll have an official prebuilt ITT Modding Engine that you can download instead of doing it from scratch.
:::

You can download a precompiled binary for version 4.26.1 (the closest version to ITT) here:
[https://github.com/Hazelight/UnrealEngine-Angelscript/releases/tag/v4.26.1-angelscript](https://github.com/Hazelight/UnrealEngine-Angelscript/releases/tag/v4.26.1-angelscript)
